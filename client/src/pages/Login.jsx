  ...
  return (
    <div className="min-h-screen flex justify-center items-center bg-gray-50 dark:bg-dark-800 py-12 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-md space-y-8">
        <div className="bg-white dark:bg-dark-700 p-8 rounded-2xl shadow-xl dark:shadow-dark-900/50 border border-gray-200 dark:border-gray-700/50">
          {/* Header */}
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Link 
                  to="/forgot-password" 
                  className="text-sm font-medium text-[#03A791] hover:text-[#03A791]/80 dark:text-[#81E7AF] dark:hover:text-[#81E7AF]/80 transition-colors duration-200"
                >
                  Forgot password?
                </Link>
              </div>
